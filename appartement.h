...
protected:
  ...
  //Methodes
public:
  Appartement(int _prix, std::string _adresse, int _surface, std::string _reference, int _id_bien, int _nb_pieces, int _etage, bool _garage, bool _cave, bool _balcon, int _nb_appart_imm);//Constructeur
  int retourner_nombrePieceAppartement(); //Methode qui retourne le nombre de pièces d'un appartement
  ...
  void afficher();//Méthode qui affiche les appartements
  inline ~Appartement() {};//Destructeur
};
