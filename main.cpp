        ...
        if (action == 3){
          ...
          if (test == true){
            ...
            if (type_bien == 2){
              ...
              while(nombre_de_piece_appartement < 0)
              {
                cout << "retapez" << endl;
